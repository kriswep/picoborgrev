...
//            }); 
        ...
        SetMotors: function(power, callback){
            if ( power < 0 ){
                ...
                console.log("wire.writeBytes(" + cmd.SET_ALL_REV + ", [" + power + "], callback");
...
//                });
                ...
                console.log("wire.writeBytes(" + cmd.SET_ALL_FWD + ", [" + power + "], callback");
...
//                });
        ...
        MotorsOff: function(callback){
          console.log("wire.writeBytes(" + cmd.ALL_OFF + ", callback");
...
//            });                    
        ...
        SetLed: function(state, callback){
            ...
            console.log("wire.writeBytes(" + cmd.SET_LED + ", [" + s + "], callback");
...
//            });
        ...
        SetEpoIgnore: function(state, callback){
            ...
            console.log("wire.writeBytes(" + cmd.SET_EPO_IGNORE + ", [" + s + "], callback");
...
//            });
        ...
        SetCommsFailsafe: function(state, callback){
            ...
            console.log("wire.writeBytes(" + cmd.SET_FAILSAFE + ", [" + s + "], callback");
...
//            });
        ...
        SetNewAddress: function(newAddress, callback){
            ...
            console.log("wire.writeBytes(" + cmd.SET_I2C_ADD + ", [" + newAddress + "], callback");
