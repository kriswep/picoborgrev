...
function picoborgrev(){
    return {
        ...
        SetMotor2: function(power, callback){
            ...
            console.log("wire.writeBytes(" + cmd + ", [" + power + "], callback");
...
//            });
        ...
        GetMotor2: function(callback){
            console.log("wire.readBytes(" + command.GET_A + ", " + limit.I2C_MAX_LEN + ", callback");
            callback(null, 100);
...
//            }); 
        ...
        SetMotors: function(power, callback){
            if ( power < 0 ){
                ...
                console.log("wire.writeBytes(" + command.SET_ALL_REV + ", [" + power + "], callback");
...
//                });
                ...
                console.log("wire.writeBytes(" + command.SET_ALL_FWD + ", [" + power + "], callback");
...
//                });
        ...
        MotorsOff: function(callback){
          console.log("wire.writeBytes(" + command.ALL_OFF + ", callback");
...
//            });
        ...
        CheckId: function(callback){
            console.log("wire.readBytes(" + command.GET_ID + ", " + limit.I2C_MAX_LEN + ", callback");
            callback(null, true);
...
//            });                    
        ...
        SetLed: function(state, callback){
            ...
            console.log("wire.writeBytes(" + command.SET_LED + ", [" + s + "], callback");
...
//            });
        ...
        GetLed: function(callback){
            console.log("wire.readBytes(" + command.GET_LED + ", " + limit.I2C_MAX_LEN + ", callback");
            callback(null, false);
...
//            });
        ...
        ResetEpo: function(callback){
          console.log("wire.writeBytes(" + RESET_EPO + ", callback");
...
//            });
        ...
        GetEpo: function(callback){
            console.log("wire.readBytes(" + command.GET_EPO + ", " + limit.I2C_MAX_LEN + ", callback");
            callback(null, false);
...
//            });
        ...
        SetEpoIgnore: function(state, callback){
            ...
            console.log("wire.writeBytes(" + command.SET_EPO_IGNORE + ", [" + s + "], callback");
...
//            });
        ...
        SetCommsFailsafe: function(state, callback){
            ...
            console.log("wire.writeBytes(" + command.SET_FAILSAFE + ", [" + s + "], callback");
...
//            });
        ...
        GetCommsFailsafe: function(callback){
          console.log("wire.readBytes(" + command.GET_FAILSAFE + ", " + limit.I2C_MAX_LEN + ", callback");
          callback(null, true);
...
//            });
        ...
        GetDriveFault: function(callback){
            ...
            console.log("wire.readBytes(" + command.GET_DRIVE_FAULT + ", " + limit.I2C_MAX_LEN + ", callback");
...
//            });
        ...
        ScanForCount: function(bus, callback){
            ...
            callback(new Error("Just stubbing."));
...
//            });
        ...
        SetNewAddress: function(newAddress, callback){
            ...
            console.log("wire.writeBytes(" + command.SET_I2C_ADD + ", [" + newAddress + "], callback");
